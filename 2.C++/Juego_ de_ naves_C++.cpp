...
// Declaración de variables estáticas para los controles del juego
...
int main(){
	...
	gotoxy(20,18); printf(" >(*_*)<  ***Game Over Prodri ***  >(*_*)< ");
	gotoxy(12,34); system("pause");
    return 0;
}
