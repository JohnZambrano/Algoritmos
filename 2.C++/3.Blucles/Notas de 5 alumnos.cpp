...
int main(){
	...
	cout<<"Los alumnos  que aprovaron todos los examenes fueron: "<<sumatotal;cout<<"\n";
	cout<<"Los alumnos  que aprovaron al menos un  examenen fueron: "<<almenostotal;cout<<"\n"; 
	cout<<"Los alumnos  que aprovaron el ultimo examenen fueron: "<<suma3;cout<<"\n";
